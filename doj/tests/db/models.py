...
class TestModel(models.Model):
    ...
    field_2 = models.BinaryField(default="010101010101010101010101")
    ...
    field_7 = models.DecimalField(max_digits=5, decimal_places=2, default=123.456)
    ...
    field_19 = models.ForeignKey('TestModelRelation', related_name='test_models', null=True)
