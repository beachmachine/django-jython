# Almost an exact copy from sqlite3 backend. We can't just import instrospection
# from django.db.backends.sqlite3, because it imports their own DatabaseOperations,
# which would import the sqlite3 module.
#
# Once #5641 is fixed, this could be avoided

from doj.backends.zxjdbc.sqlite3.base import DatabaseOperations
